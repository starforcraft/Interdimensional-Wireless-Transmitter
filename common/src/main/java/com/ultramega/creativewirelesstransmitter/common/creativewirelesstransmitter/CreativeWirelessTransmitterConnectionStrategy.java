...
class CreativeWirelessTransmitterConnectionStrategy extends ColoredConnectionStrategy {
    CreativeWirelessTransmitterConnectionStrategy(final Supplier<BlockState> blockStateProvider, final BlockPos origin) {
