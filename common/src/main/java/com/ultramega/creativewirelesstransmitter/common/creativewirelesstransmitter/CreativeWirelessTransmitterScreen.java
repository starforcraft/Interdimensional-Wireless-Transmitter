...
public class CreativeWirelessTransmitterScreen extends AbstractBaseScreen<CreativeWirelessTransmitterContainerMenu> {
    ...
    public CreativeWirelessTransmitterScreen(final CreativeWirelessTransmitterContainerMenu containerMenu,
    ...
    protected void renderLabels(final GuiGraphics graphics, final int mouseX, final int mouseY) {
        ...
        graphics.drawString(
            font,
            createCreativeWirelessTransmitterTranslation("gui", "creative_wireless_transmitter.distance"),
            7 + icon.getWidth() + 4,
            25,
            4210752,
            false
